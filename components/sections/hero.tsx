...
export default function Hero() {
    return (
        <section className="min-h-screen flex items-center bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-6 py-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <Link href="#projects" className="btn-primary flex items-center justify-center sm:justify-start gap-2">
                                Explore Projects
                                <ArrowRight size={18} />
                            </Link>
                    ...
                    <div className="hidden md:flex items-center justify-center">
                        <div className="w-full aspect-square bg-gradient-to-br from-neutral-800 to-neutral-900 rounded-2xl flex items-center justify-center border border-accent-primary/20">
